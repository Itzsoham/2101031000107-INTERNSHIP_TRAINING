...
namespace DatabaseCr {
    ...
    public partial class DB1DataSet : global::System.Data.DataSet {
        ...
        public partial class datatableDataTable : global::System.Data.TypedTableBase<datatableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public datatableRow AdddatatableRow(string Name, string Address) {
...
namespace DatabaseCr.DB1DataSetTableAdapters {
    ...
    public partial class datatableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[datatable] WHERE (([Id] = @Original_Id) AND ([Name] = @Origina" +
                "l_Name) AND ([Address] = @Original_Address))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[datatable] ([Name], [Address]) VALUES (@Name, @Address);\r\nSELE" +
                "CT Id, Name, Address FROM datatable WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[datatable] SET [Name] = @Name, [Address] = @Address WHERE (([Id] = " +
                "@Original_Id) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address))" +
                ";\r\nSELECT Id, Name, Address FROM datatable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseCr.Properties.Settings.Default.DB1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Address FROM dbo.datatable";
        ...
        public virtual int Fill(DB1DataSet.datatableDataTable dataTable) {
        ...
        public virtual DB1DataSet.datatableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB1DataSet.datatableDataTable dataTable = new DB1DataSet.datatableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB1DataSet.datatableDataTable dataTable) {
